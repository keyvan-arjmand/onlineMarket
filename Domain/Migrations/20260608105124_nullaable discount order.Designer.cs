...
namespace Domain.Migrations
{
    ...
    [Migration("20260608105124_nullaable discount order")]
    partial class nullaablediscountorder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Products.ProductFav", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProductFavs");
                });

            modelBuilder.Entity("Domain.Entities.Regions.Region", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Orders.Order", b =>
                {
                    b.HasOne("Domain.Entities.Regions.Region", "Region")
                        .WithMany()
                        .HasForeignKey("RegionId");

                    b.HasOne("Domain.Entities.Identities.User", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.Regions.Region", b =>
                {
                    b.HasOne("Domain.Entities.Regions.Region", "Parent")
                        .WithMany()
